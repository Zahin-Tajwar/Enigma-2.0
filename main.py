...
def rotorsetting(l,m,n):
    #this implementation is referred to as ring setting
...
def shift():
    ...
    #always change rotor fast and so if needed, increase countf
...
# frame for clear and export buttons
...
# frame for help and quit buttons
